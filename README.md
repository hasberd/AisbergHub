...
antiLabel.Size = UDim2.new(0, 170, 0, 20)
antiLabel.Position = UDim2.new(0, 10, 0, 120)
antiLabel.BackgroundTransparency = 1
antiLabel.Text = "Aisberg AntiAFK"
antiLabel.TextColor3 = Color3.fromRGB(230,230,240)
antiLabel.Font = Enum.Font.Gotham
antiLabel.TextSize = 14
antiLabel.TextTransparency = 1
antiLabel.Parent = mainPage

local antiStatus = Instance.new("TextLabel")
antiStatus.Size = UDim2.new(0, 170, 0, 20)
antiStatus.Position = UDim2.new(0, 10, 0, 140)
...
antiStatus.Parent = mainPage

local antiBtn = Instance.new("TextButton")
antiBtn.Size = UDim2.new(0, 170, 0, 26)
antiBtn.Position = UDim2.new(0, 10, 0, 165)
...
local function fadeIn()
    ...
    for _, ui in ipairs(guiElements) do
        if ui then ui.TextTransparency = 1 end
    end
...
print("AisbergHub (fresh) загружен. Нажми K для меню.")
