...
lua
--================= ANIMATION (scale + fade, semi-transparent) =================--
...
local function setTextsTransparency(value)
...
local function fadeIn()
    ...
    for _, ui in ipairs(guiElements) do
        if ui and ui:IsA("GuiObject") then
            ...
            TweenService:Create(ui, TweenInfo.new(tweenTime), props):Play()
        end
    end
end
